...
export default function ClientFacingInvoice() {
  ...
  if (!invoice) return <div className="p-10 text-white bg-slate-950 flex justify-center items-center h-screen font-black uppercase tracking-widest">Loading Invoice...</div>;
  ...
  const theme = {
    ...
    reqMoneyBg: isLightMode ? "bg-red-50 border-red-200" : "bg-red-900/20 border-red-500/30",
    reqMoneyText: isLightMode ? "text-red-700" : "text-red-400",
  };
          ...
          >
            ...
            <div className="flex justify-between items-start mb-10">
              ...
              <div className="text-right flex flex-col items-end">
                <h2 className="bg-black text-white px-5 py-1.5 text-xl font-black uppercase tracking-tighter mb-2 italic shadow-sm">Invoice #{invoice.jobs?.[0]?.job_number || "TBD"}</h2>
                <div className={`text-[9px] font-black uppercase tracking-[0.2em] px-3 py-1 border shadow-sm ${balanceDue <= 0.01 ? 'border-emerald-500 text-emerald-600 bg-emerald-50' : 'border-sky-400 text-sky-500 bg-sky-50'}`}>
           ...
           {/* LINE ITEMS TABLE */}
            ...
            <div className="flex justify-between items-start pt-6 border-t-[6px] border-black mt-auto">
              ...
              <div className="w-1/2 space-y-5">
                ...
                {balanceDue > 0.01 && (
          <div className={`w-full ${theme.reqMoneyBg} p-3 rounded-xl border shadow-2xl flex flex-col sm:flex-row items-center gap-3 transition-colors print:hidden`}>
            <div className={`${theme.reqMoneyText} text-[10px] font-black uppercase tracking-widest flex items-center justify-center sm:justify-start w-full sm:w-[130px] shrink-0`}>
                ...
                {/* --- DIGITAL GOOGLE REVIEW CTA (HIDDEN ON PRINT PDF) --- */}
